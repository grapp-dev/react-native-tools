...
import { FileFormatterService } from './FileFormatterService';
...
export class FileSystemService extends Effect.Service<FileSystemService>()('FileSystem', {
  effect: Effect.gen(function* (_) {
    ...
    const writeFileFromDeclarations = (
      ...
      return Effect.gen(function* (_) {
        ...
        const content = yield* FileFormatter.format(
  ...
  dependencies: [NodeContext.layer, FileFormatterService.layer],
}) {
